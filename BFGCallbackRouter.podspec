...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Craig Pearlman"
  # s.authors            = { "Craig Pearlman" => "github-public@craig.blackfog.net" }
  ...
  s.source       = { :git => "https://github.com/blackfog/BFGCallbackRouter.git", :tag => "1.0.0" }
  ...
  s.source_files  = "BFGCallbackRouter", "BFGCallbackRouter/**/*.{h,m}"
